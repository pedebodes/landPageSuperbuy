...
/*-----------------------------------------------------------------------------------*/
/*It has been edited to work differently for Live Preview - The original one is present in this folder named 'shortcodes-backup.php' */
/*****************
Header Section- 1
*****************/
...
function apparatus_header_section_one_shortcode( $atts ) {
	...
	if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo One') || (($apparatus_description == 'Apparatus | Software Demo One')))){
		$unique_css_class = 'hsritq';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Two') || (($apparatus_description == 'Apparatus | Software Demo Two')))){
		$unique_css_class = 'hsaritq';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Three') || (($apparatus_description == 'Apparatus | Software Demo Three')))){
		$unique_css_class = 'hsrsitq';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Four-OLD') || (($apparatus_description == 'Apparatus | Software Demo Four-OLD')))){
		$unique_css_class = 'hsridtq';
	}
	...
	<div style="background-image:url('.esc_url($images[0]).');background-size: contain;background-position: top;background-repeat: no-repeat;" class="'.esc_attr($unique_css_class).' dif-mobile-bg">
        ...
        <!-- How it works end -->
		';
if(!empty($unique_css_class) && ($apparatus_description != 'Apparatus | App Demo One') && ($apparatus_description != 'Apparatus | Software Demo One') && ($apparatus_description != 'Apparatus | App Demo Two') && ($apparatus_description != 'Apparatus | Software Demo Two') && ($apparatus_description != 'Apparatus | App Demo Three') && ($apparatus_description != 'Apparatus | Software Demo Three') && ($apparatus_description != 'Apparatus | App Demo Four-OLD') && ($apparatus_description != 'Apparatus | Software Demo Four-OLD')){ $output.='
<style>
...
';}	
if(!empty($images3[0]) && ($apparatus_description != 'Apparatus | App Demo One') && ($apparatus_description != 'Apparatus | App Demo Two') && ($apparatus_description != 'Apparatus | App Demo Three') && ($apparatus_description != 'Apparatus | App Demo Four-OLD')){ $output.='
<style>
...
'; }
if(!empty($unique_css_class) && ($apparatus_description != 'Apparatus | App Demo One') && ($apparatus_description != 'Apparatus | Software Demo One') && ($apparatus_description != 'Apparatus | App Demo Two') && ($apparatus_description != 'Apparatus | Software Demo Two') && ($apparatus_description != 'Apparatus | App Demo Three') && ($apparatus_description != 'Apparatus | Software Demo Three') && ($apparatus_description != 'Apparatus | App Demo Four-OLD') && ($apparatus_description != 'Apparatus | Software Demo Four-OLD')){ 
...
function apparatus_header_section_two_shortcode( $atts ) {
	...
	<div style="background-image:url('.esc_url($images[0]).');background-size: contain;background-position: top;background-repeat: no-repeat;" class="'.esc_attr($unique_css_class).' dif-mobile-bg">
        ...
        <!-- How it works end -->
		';
$apparatus_description = get_bloginfo( 'name' ); if(!empty($unique_css_class) && ($apparatus_description != 'Apparatus | App Demo One') && ($apparatus_description != 'Apparatus | Software Demo One') && ($apparatus_description != 'Apparatus | App Demo Two') && ($apparatus_description != 'Apparatus | Software Demo Two') && ($apparatus_description != 'Apparatus | App Demo Three') && ($apparatus_description != 'Apparatus | Software Demo Three') && ($apparatus_description != 'Apparatus | App Demo Four-OLD') && ($apparatus_description != 'Apparatus | Software Demo Four-OLD')){ $output.='
<style>
'; if(!empty($heading1_color)){ $output.='
.header-section-one.'.wp_trim_words($unique_css_class).' .heading1{
	color:'.esc_attr($heading1_color).';
...
';}	
if(!empty($images3[0]) && ($apparatus_description != 'Apparatus | Software Demo One') && ($apparatus_description != 'Apparatus | Software Demo Two') && ($apparatus_description != 'Apparatus | Software Demo Three') && ($apparatus_description != 'Apparatus | Software Demo Four-OLD')){ $output.='
<style>
@media (max-width: 768px){
.dif-mobile-bg{
    background-image: url('.esc_url($images3[0]).') !important;
...
function apparatus_video_sec_one_shortcode( $atts ) {
	...
	$apparatus_description = get_bloginfo( 'name' );
	if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo One') || (($apparatus_description == 'Apparatus | Software Demo One')))){
		$unique_css_class = 'sritq';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Two') || (($apparatus_description == 'Apparatus | Software Demo Two')))){
		$unique_css_class = 'saritq';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Three') || (($apparatus_description == 'Apparatus | Software Demo Three')))){
		$unique_css_class = 'srsitq';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Four-OLD') || (($apparatus_description == 'Apparatus | Software Demo Four-OLD')))){
		$unique_css_class = 'sridtq';
	}
...
function apparatus_pricing_table_one_shortcode( $atts ) {
	...
	$apparatus_description = get_bloginfo( 'name' );
	if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo One') || (($apparatus_description == 'Apparatus | Software Demo One')))){
		$unique_css_class = 'pcqro';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Two') || (($apparatus_description == 'Apparatus | Software Demo Two')))){
		$unique_css_class = 'pacqro';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Three') || (($apparatus_description == 'Apparatus | Software Demo Three')))){
		$unique_css_class = 'pcsqro';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Four-OLD') || (($apparatus_description == 'Apparatus | Software Demo Four-OLD')))){
		$unique_css_class = 'pcqrdo';
	}
	$content='';	
	if(!empty($features)){
...
';}	
if(!empty($mute_features) && ($apparatus_description != 'Apparatus | App Demo One') && ($apparatus_description != 'Apparatus | Software Demo One') && ($apparatus_description != 'Apparatus | App Demo Two') && ($apparatus_description != 'Apparatus | Software Demo Two') && ($apparatus_description != 'Apparatus | App Demo Three') && ($apparatus_description != 'Apparatus | Software Demo Three') && ($apparatus_description != 'Apparatus | App Demo Four-OLD') && ($apparatus_description != 'Apparatus | Software Demo Four-OLD')){ $output.='
<style>
.disabled-features{
	margin-top:-15px;
}
...
function apparatus_counter_section_one_shortcode( $atts ) {
	...
	$apparatus_description = get_bloginfo( 'name' );
	if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo One') || (($apparatus_description == 'Apparatus | Software Demo One')))){
		$unique_css_class = 'usvtb';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Two') || (($apparatus_description == 'Apparatus | Software Demo Two')))){
		$unique_css_class = 'usavtb';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Three') || (($apparatus_description == 'Apparatus | Software Demo Three')))){
		$unique_css_class = 'ussvtb';
	} if(!empty($unique_css_class) && (($apparatus_description == 'Apparatus | App Demo Four-OLD') || (($apparatus_description == 'Apparatus | Software Demo Four-OLD')))){
		$unique_css_class = 'usvdtb';
	}
