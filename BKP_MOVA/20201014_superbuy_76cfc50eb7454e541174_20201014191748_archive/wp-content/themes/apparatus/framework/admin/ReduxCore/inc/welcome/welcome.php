<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo esc_html__( 'Thank you from us!', 'apparatus' );
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'apparatus' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'apparatus' ), esc_html__( 'Redux Framework', 'apparatus' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'apparatus' ), esc_html__( 'Redux Framework Changelog', 'apparatus' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'apparatus' ), esc_html__( 'Get Support', 'apparatus' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'apparatus' ), esc_html__( 'Redux Extensions', 'apparatus' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'apparatus' ), esc_html__( 'The people that develop Redux Framework', 'apparatus' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'apparatus' ), esc_html__( 'Redux Framework Status', 'apparatus' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo esc_attr($selected) == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'apparatus' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'apparatus' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'apparatus' ); ?>
                    ...
                    <?php esc_html_e( 'Credits', 'apparatus' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'apparatus' ); ?>
                    ...
                    <?php esc_attr_e( 'Status', 'apparatus' ); ?>
                </a>
            </h2>
            <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'apparatus' ), esc_html( $contributor->login ) ) )
                );
