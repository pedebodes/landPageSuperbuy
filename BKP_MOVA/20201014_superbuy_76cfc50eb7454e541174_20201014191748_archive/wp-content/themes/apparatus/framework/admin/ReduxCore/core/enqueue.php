        ...
        class reduxCoreEnqueue {
            ...
            private function register_styles() {
                ...
                Redux_CDN::register_style(
                    'select2-css',
                    ReduxFramework::$_url . 'assets/js/vendor/select2.css',
                    array(),
            ...
            private function register_scripts() {
                ...
                wp_enqueue_script(
                    'webfontloader',
                    ReduxFramework::$_url . 'assets/js/vendor/webfont' . $this->min . '.js',
                    array( 'jquery' ),
                    '1.5.0',
                    true
                );
            ...
            private function set_localized_data() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'apparatus' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", esc_html__( 'Are you sure? Resetting will lose all custom values.', 'apparatus' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", esc_html__( 'Are you sure? Resetting will lose all custom values in this section.', 'apparatus' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'apparatus' ) );
                 ...
                 */
                $import_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/import", esc_html__( 'Your current options will be replaced with the values of this import. Would you like to proceed?', 'apparatus' ) );
                ...
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => esc_attr__( 'Please Wait', 'apparatus' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => esc_html__( 'There was an error saving. Here is the result of your action:', 'apparatus' ),
                    'alert'   => esc_html__( 'There was a problem with your action. Please try again or reload the page.', 'apparatus' ),
                );
