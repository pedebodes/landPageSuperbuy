<div class="wrap about-wrap">
    <h1><?php printf( esc_attr__( 'Welcome to Redux Framework %s', 'apparatus' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( esc_attr__( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'apparatus' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
            class="el el-redux"></i><span><?php printf( esc_attr__( 'Version %s', 'apparatus' ), ReduxFramework::$_version ); ?></span>
    </div>
    ...
    <div id="redux-message" class="updated">
        <h4><?php esc_html_e( 'What is Redux Framework?', 'apparatus' ); ?></h4>
        ...
        <p><?php esc_html_e( 'Redux Framework is the core of many products on the web. It is an option framework which developers use to
            enhance their products.', 'apparatus' ); ?></p>

        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               target="_blank"><?php esc_html_e( 'Learn More', 'apparatus' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php esc_html_e( 'New in this Release', 'apparatus' ); ?></h2>
