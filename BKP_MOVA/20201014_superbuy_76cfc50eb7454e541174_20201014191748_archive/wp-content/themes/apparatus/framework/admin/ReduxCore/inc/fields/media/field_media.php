...
if ( ! class_exists( 'ReduxFramework_media' ) ) {
    ...
    class ReduxFramework_media {
        ...
        public function render() {
            ...
            echo '<img class="redux-option-image" id="image_' . $this->field['id'] . '" src="' . $this->value['thumbnail'] . '" alt="'.esc_attr__('option-image', 'apparatus').'" target="_blank" rel="external" />';
            echo '</a>';
            echo '</div>';
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . esc_attr__( 'Upload', 'apparatus' ) . '</span>';
            ...
            echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . esc_attr__( 'Remove', 'apparatus' ) . '</span>';
