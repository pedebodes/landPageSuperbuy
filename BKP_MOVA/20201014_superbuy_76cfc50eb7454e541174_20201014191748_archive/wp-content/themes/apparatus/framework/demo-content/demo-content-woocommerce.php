...
function apparatus_oneclick_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo1/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo1/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo1/customizer.dat',
	...
	array(
      ...
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo2/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo2/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo2/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'App' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo3/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo3/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo3/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'Software' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo4/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo4/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo4/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'App' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo5/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo5/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo5/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'Software' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo6/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo6/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo6/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'App' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo7/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo7/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo7/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'Software' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo8/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo8/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo8/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'App' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo9/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo9/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo9/customizer.dat',
	...
	array(
      ...
      'categories'                   => array( 'Software' ),
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo10/demo-content.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo10/widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'framework/demo-content/woo_commerce/demo10/customizer.dat',
